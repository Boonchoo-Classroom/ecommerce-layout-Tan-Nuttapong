...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("Puma LaMelo Ball MB.01", "Rick and Morty", 229.00, R.drawable.mb01))
        ...
        promotionsList.add(ProductModel("แถม ถูงเท้า PUMA 1 คู่", "เพียงซื้อ Puma LaMelo Ball MB.01 Rick and Morty", 229.00, R.drawable.sock))
